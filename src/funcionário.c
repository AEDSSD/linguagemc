...
int main(){
    system("clear");
    struct  funcionário fun;
    printf("Digite o nome do funcionário: \n");
    fgets(fun.nome,sizeof(fun.nome),stdin);

    printf("Digite Salário do funcionário: \n");
    scanf("%f",&fun.salario);

    printf("Digite o  de convênio do funcionário: \n");
    ...
    //Foi criado o vetor c_salario para guarda o valor do salário convertido
    //em char. Somente assim, será concatenado com o tecto Salário R$
    char c_salario[10];
    
    //Estamos usando  o comando spring para converter o valor digitado
