...
int main(){
    ...
    printf("Digite o e-mail do do cliente: \n");
    ...
    //formato de string. E, também usauremos o comando sprintf(String Print Format)
    //o inicio do comando pede o array de chars para guaradar o resultado
    //da conversão, o segundo itam do comando pede o formato original do valor
